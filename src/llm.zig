...
pub const LLMClient = struct {
    ...
    pub fn buildRequestBody(self: *LLMClient, body: *std.ArrayList(u8), prompt: []const u8) !void {
    ...
    pub fn extractResponseText(self: *LLMClient, response_body: []const u8) ![]const u8 {
        // Parse JSON response
    ...
    pub fn parseResponse(self: *LLMClient, response: []const u8) ![]Relationship {
